            ...
            Padding(padding: EdgeInsets.symmetric(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: AppSize.s10.h,),
                  CustomTextField(controller: nameEditingController, contentPadding: AppSize.s20,),

                  SizedBox(height: AppSize.s27.h,),

                  const LabelText(text: AppStrings.email),
                  SizedBox(height: AppSize.s10.h,),
                  const EditProfileItem(iconName: AppImages.good, title: AppStrings.areousEmail, textColor: ColorManager.greenColor, borderColor: ColorManager.greenColor,),

                  SizedBox(height: AppSize.s27.h,),

                  const LabelText(text: AppStrings.userName),
                  SizedBox(height: AppSize.s10.h,),
                  const EditProfileItem(iconName: AppImages.good, title: AppStrings.areous, textColor: ColorManager.greenColor, borderColor: ColorManager.greenColor),

                  SizedBox(height: AppSize.s27.h,),

                  const LabelText(text: AppStrings.phone),
                  SizedBox(height: AppSize.s10.h,),
                  EditProfileItem(iconName: AppImages.close, title: AppStrings.phoneNumber, textColor: ColorManager.errorColor, borderColor: ColorManager.errorColor),
