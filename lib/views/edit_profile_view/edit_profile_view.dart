        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              CustomTextField(
                controller: userProfileViewModel.nameEditingController,
              ...
              EditProfileItem(
                  // iconName: authProvider.userData.user!.emailVerified!
                  //     ? AppImages.good
                  //     : AppImages.close,
              ...
              EditProfileItem(
                  // iconName: authProvider.userData.user!.phoneVerified!
                  //     ? AppImages.good
                  //     : AppImages.close,
                ...
                return CustomElevatedButton(
                    onTap: () async {
                      ...
                      if (base64Image.isNotEmpty) {
                        ...
                        final updated = await auth.updateProfilePhoto(
                            idCard: base64Image,
                            context: context,
