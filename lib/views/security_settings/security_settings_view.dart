                ...
                Row(
                  ...
                  children: [
                    Expanded(child: Column(
                      ...
                      children: [
                        const CustomText(text: AppStrings.twoFactorAuth, fontWeight: FontWeightManager.medium, fontSize: FontSize.s16,),
                        SizedBox(
                            width: AppSize.s229.w,
                            child: const CustomTextWithLineHeight(text: AppStrings.with2StepVerification, fontSize: FontSize.s10, textColor: Color.fromRGBO(133, 133, 133, 1),))
                      ],
                    ),),
                    InkWell(
                      onTap: (){
                        ...
                        child: SvgPicture.asset(isTwoFactorAuth ? AppImages.toggleOn : AppImages.toggleOff)),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    Expanded(child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const CustomText(text: AppStrings.changePassword, fontWeight: FontWeightManager.medium, fontSize: FontSize.s16,),
                        SizedBox(
                            width: AppSize.s229.w,
                ...
                Row(
                  ...
                  children: [
                    Expanded(child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const CustomText(text: AppStrings.allowBioMetrics, fontWeight: FontWeightManager.medium, fontSize: FontSize.s16,),
                        SizedBox(
                            width: AppSize.s229.w,
                    ...
                    InkWell(
                        ...
                        child: SvgPicture.asset(isAllowBioMetric ? AppImages.toggleOn : AppImages.toggleOff)),
