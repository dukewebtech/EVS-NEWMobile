...
class PhoneNumberVerificationView extends StatefulWidget {
  ...
  @override
  State<PhoneNumberVerificationView> createState() => _PhoneNumberVerificationViewState();
}

class _PhoneNumberVerificationViewState extends State<PhoneNumberVerificationView> {
            ...
            Padding(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      SizedBox(
                        ...
                        child: const CustomTextWithLineHeight(text: AppStrings.verifyPhone, textColor: ColorManager.blackTextColor, fontSize: FontSize.s30, fontWeight: FontWeightManager.bold,),),
                    ],
                  ),
                  Row(
                    children: const [
                      SizedBox(
                          child: CustomTextWithLineHeight(text: AppStrings.confirmPinForApp, textColor: ColorManager.semiBlackTextColor, fontWeight: FontWeightManager.regular, fontSize: FontSize.s14,)),
                    ],
                  ),
                  ...
                  Center(
                    child: CustomTextWithLineHeight(text: AppStrings.verify.toUpperCase(), textColor: ColorManager.lightTextColor, fontWeight: FontWeightManager.light, fontSize: FontSize.s15,),
                  ),
                  ...
                  }, backgroundColor: ColorManager.primaryColor, textColor: ColorManager.blackTextColor, title: AppStrings.verify.toUpperCase()),
