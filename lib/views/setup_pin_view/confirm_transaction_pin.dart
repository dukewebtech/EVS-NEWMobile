            ...
            Padding(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      SizedBox(
                        ...
                        child: const CustomTextWithLineHeight(text: AppStrings.confirmPin, textColor: ColorManager.blackTextColor, fontSize: FontSize.s30, fontWeight: FontWeightManager.bold,),),
                    ],
                  ),
                  Row(
                    children: const [
                  ...
                  Center(
                    child: CustomTextWithLineHeight(text: AppStrings.confirmPin.toUpperCase(), textColor: ColorManager.lightTextColor, fontWeight: FontWeightManager.light, fontSize: FontSize.s15,),
                  ),
                  ...
                  }, backgroundColor: ColorManager.primaryColor, textColor: ColorManager.blackTextColor, title: AppStrings.confirmPin.toUpperCase()),
