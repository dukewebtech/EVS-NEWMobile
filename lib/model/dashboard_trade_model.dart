...
DashboardTradeModel dashboardTradeModelFromJson(String str) => DashboardTradeModel.fromJson(json.decode(str));

String dashboardTradeModelToJson(DashboardTradeModel data) => json.encode(data.toJson());
...
class DashboardTradeModel {
  ...
  factory DashboardTradeModel.fromJson(Map<String, dynamic> json) => DashboardTradeModel(
    trades: List<DashboardTradeData>.from(json["data"].map((x) => DashboardTradeData.fromJson(x))),
...
class DashboardTradeData {
  ...
  factory DashboardTradeData.fromJson(Map<String, dynamic> json) => DashboardTradeData(
