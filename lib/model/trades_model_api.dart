...
//
//     final tradessModel = tradessModelFromJson(jsonString);

import 'dart:convert';

TradesModel tradesModelFromJson(String str) => TradesModel.fromJson(json.decode(str));
...
class TradesModel {
  ...
  factory TradesModel.fromJson(Map<String, dynamic> json) => TradesModel(
    trades: List<TradeData>.from(json["data"].map((x) => TradeData.fromJson(x))),
...
class TradeData {
  ...
  factory TradeData.fromJson(Map<String, dynamic> json) => TradeData(
    ...
    paymentMethod: TradePaymentMethod.fromJson(json["payment_method"]),
  );
